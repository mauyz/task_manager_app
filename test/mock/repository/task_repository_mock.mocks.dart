...
// in task_manager_app/test/mock/repository/task_repository_mock.dart.
...
import 'package:task_manager_app/domain/model/task.dart' as _i2;
import 'package:task_manager_app/domain/repository/task_repository.dart' as _i3;
...
class MockTaskRepository extends _i1.Mock implements _i3.TaskRepository {
  ...
  @override
  _i4.Future<List<_i2.Task>> getTaskList() => (super.noSuchMethod(
        Invocation.method(
          #getTaskList,
          [],
        ),
  ...
  @override
  _i4.Future<void> updateTask(_i2.Task? task) => (super.noSuchMethod(
        Invocation.method(
          #updateTask,
          [task],
        ),
