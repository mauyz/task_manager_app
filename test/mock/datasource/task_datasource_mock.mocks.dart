...
class MockTaskDatasource extends _i1.Mock implements _i2.TaskDatasource {
  ...
  @override
  _i3.Future<List<Map<String, dynamic>>> getAllTasks() =>
      (super.noSuchMethod(
  ...
  _i3.Future<Map<String, dynamic>> insertTask(
    Map<String, dynamic>? taskEntity,
      ...
      (super.noSuchMethod(
            Invocation.method(#insertTask, [taskEntity]),
  ...
  _i3.Future<void> updateTask(Map<String, dynamic>? taskEntity) =>
      (super.noSuchMethod(
            Invocation.method(#updateTask, [taskEntity]),
  ...
  @override
  _i3.Future<void> deleteTask(int? taskId) =>
      (super.noSuchMethod(
